...
5. Declare exact files, real data dependencies and a focused verification command.
6. Use one fullstack plan with ordered backend/frontend tasks; do not create dual pipelines.
7. Write `{phase_dir}/{NN}-PLAN.md`, normally <=300 lines and always <=600.
</workflow>
