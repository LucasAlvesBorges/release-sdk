...
#   #11 effort is max by default, honors CODEX_REASONING_EFFORT
...
echo "── #11 effort ──"
eq "default effort → max" "max" "$(unset CODEX_REASONING_EFFORT; release_model_effort)"
eq "honors CODEX_REASONING_EFFORT" "high" "$(CODEX_REASONING_EFFORT=high release_model_effort)"
