...
**Current version: v0.26.0** — short `/release:*` invocation with isolated Claude Code and Codex distributions. See [CHANGELOG.md](./CHANGELOG.md) for the full evolution.
