...
description: >
  Close the current milestone. Runs the milestone-auditor to verify every phase is
...
`/Users/lucas/release/personal/django-sdk/agents/milestone-auditor.md`). Inputs:
